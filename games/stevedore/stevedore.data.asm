...
.COCONUT:
	...
	db	BULLET_DIR_DOWN OR 4 ; (4 pixels / frame)
; -----------------------------------------------------------------------------
...
; Sprite-related symbolic constants (SPRATR)
	...
	SNAKE_SPRITE_COLOR_2:		equ 3

	MONKEY_SPRITE_PATTERN:		equ $80
	MONKEY_SPRITE_COLOR_1:		equ 9
	MONKEY_SPRITE_COLOR_2:		equ 8
	...
	COCONUT_SPRITE_COLOR:		equ 10

	SPARK_SPRITE_PATTERN:		equ $dc
	SPARK_SPRITE_COLOR:		equ 10
	
	BOX_SPRITE_PATTERN:		equ $e0
	BOX_SPRITE_COLOR:		equ 9
	
	ROCK_SPRITE_PATTERN:		equ $e4
