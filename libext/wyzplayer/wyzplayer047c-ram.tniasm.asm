...
; (c) [WYZ] 22.03.2016
;
; tniASM syntax version by theNestruo
; RAM part
;
...
VOL_INST_B:	rb	1 ;DB VOLUMEN RELATIVO DEL INSTRUMENTO DEL CANAL B
...
;SELECT_CANAL_P	rb	1 ;DB SELECCION DE CANAL DE EFECTOS DE RITMO
